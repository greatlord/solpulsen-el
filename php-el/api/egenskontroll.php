<?php
// api/egenkontroll.php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

require_once __DIR__ . '/../controllers/EgenkontrollController.php';
...
try {
    ...
    if (isset($queryParams['photoId'])) {
        EgenkontrollController::getPhoto($queryParams['photoId']);
        exit;
    }
    ...
    switch ($method) {
        case 'GET':
            if (isset($queryParams['id'])) {
                EgenkontrollController::get($queryParams['id']);
            } else {
                EgenkontrollController::getAll();
            }
            break;
        ...
        case 'POST':
            ...
            EgenkontrollController::create($input);
            break;
        ...
        case 'PUT':
            ...
            EgenkontrollController::update($queryParams['id'], $input);
            break;
        ...
        case 'DELETE':
            ...
            EgenkontrollController::delete($queryParams['id']);
            break;
